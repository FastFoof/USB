// niosii_USB_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module niosii_USB_mm_interconnect_0 (
		...
		output wire [4:0]  performance_counter_control_slave_address,       // performance_counter_control_slave.address
		...
		output wire [7:0]  SD_avalon_sdcard_slave_address,                  //            SD_avalon_sdcard_slave.address
		output wire        SD_avalon_sdcard_slave_write,                    //                                  .write
		output wire        SD_avalon_sdcard_slave_read,                     //                                  .read
		input  wire [31:0] SD_avalon_sdcard_slave_readdata,                 //                                  .readdata
		output wire [31:0] SD_avalon_sdcard_slave_writedata,                //                                  .writedata
		output wire [3:0]  SD_avalon_sdcard_slave_byteenable,               //                                  .byteenable
		input  wire        SD_avalon_sdcard_slave_waitrequest,              //                                  .waitrequest
		output wire        SD_avalon_sdcard_slave_chipselect,               //                                  .chipselect
	...
	wire   [31:0] sd_avalon_sdcard_slave_agent_m0_readdata;                                  // SD_avalon_sdcard_slave_translator:uav_readdata -> SD_avalon_sdcard_slave_agent:m0_readdata
	wire          sd_avalon_sdcard_slave_agent_m0_waitrequest;                               // SD_avalon_sdcard_slave_translator:uav_waitrequest -> SD_avalon_sdcard_slave_agent:m0_waitrequest
	wire          sd_avalon_sdcard_slave_agent_m0_debugaccess;                               // SD_avalon_sdcard_slave_agent:m0_debugaccess -> SD_avalon_sdcard_slave_translator:uav_debugaccess
	wire   [28:0] sd_avalon_sdcard_slave_agent_m0_address;                                   // SD_avalon_sdcard_slave_agent:m0_address -> SD_avalon_sdcard_slave_translator:uav_address
	wire    [3:0] sd_avalon_sdcard_slave_agent_m0_byteenable;                                // SD_avalon_sdcard_slave_agent:m0_byteenable -> SD_avalon_sdcard_slave_translator:uav_byteenable
	wire          sd_avalon_sdcard_slave_agent_m0_read;                                      // SD_avalon_sdcard_slave_agent:m0_read -> SD_avalon_sdcard_slave_translator:uav_read
	wire          sd_avalon_sdcard_slave_agent_m0_readdatavalid;                             // SD_avalon_sdcard_slave_translator:uav_readdatavalid -> SD_avalon_sdcard_slave_agent:m0_readdatavalid
	wire          sd_avalon_sdcard_slave_agent_m0_lock;                                      // SD_avalon_sdcard_slave_agent:m0_lock -> SD_avalon_sdcard_slave_translator:uav_lock
	wire   [31:0] sd_avalon_sdcard_slave_agent_m0_writedata;                                 // SD_avalon_sdcard_slave_agent:m0_writedata -> SD_avalon_sdcard_slave_translator:uav_writedata
	wire          sd_avalon_sdcard_slave_agent_m0_write;                                     // SD_avalon_sdcard_slave_agent:m0_write -> SD_avalon_sdcard_slave_translator:uav_write
	wire    [2:0] sd_avalon_sdcard_slave_agent_m0_burstcount;                                // SD_avalon_sdcard_slave_agent:m0_burstcount -> SD_avalon_sdcard_slave_translator:uav_burstcount
	wire          sd_avalon_sdcard_slave_agent_rf_source_valid;                              // SD_avalon_sdcard_slave_agent:rf_source_valid -> SD_avalon_sdcard_slave_agent_rsp_fifo:in_valid
	wire  [107:0] sd_avalon_sdcard_slave_agent_rf_source_data;                               // SD_avalon_sdcard_slave_agent:rf_source_data -> SD_avalon_sdcard_slave_agent_rsp_fifo:in_data
	wire          sd_avalon_sdcard_slave_agent_rf_source_ready;                              // SD_avalon_sdcard_slave_agent_rsp_fifo:in_ready -> SD_avalon_sdcard_slave_agent:rf_source_ready
	wire          sd_avalon_sdcard_slave_agent_rf_source_startofpacket;                      // SD_avalon_sdcard_slave_agent:rf_source_startofpacket -> SD_avalon_sdcard_slave_agent_rsp_fifo:in_startofpacket
	wire          sd_avalon_sdcard_slave_agent_rf_source_endofpacket;                        // SD_avalon_sdcard_slave_agent:rf_source_endofpacket -> SD_avalon_sdcard_slave_agent_rsp_fifo:in_endofpacket
	wire          sd_avalon_sdcard_slave_agent_rsp_fifo_out_valid;                           // SD_avalon_sdcard_slave_agent_rsp_fifo:out_valid -> SD_avalon_sdcard_slave_agent:rf_sink_valid
	wire  [107:0] sd_avalon_sdcard_slave_agent_rsp_fifo_out_data;                            // SD_avalon_sdcard_slave_agent_rsp_fifo:out_data -> SD_avalon_sdcard_slave_agent:rf_sink_data
	wire          sd_avalon_sdcard_slave_agent_rsp_fifo_out_ready;                           // SD_avalon_sdcard_slave_agent:rf_sink_ready -> SD_avalon_sdcard_slave_agent_rsp_fifo:out_ready
	wire          sd_avalon_sdcard_slave_agent_rsp_fifo_out_startofpacket;                   // SD_avalon_sdcard_slave_agent_rsp_fifo:out_startofpacket -> SD_avalon_sdcard_slave_agent:rf_sink_startofpacket
	wire          sd_avalon_sdcard_slave_agent_rsp_fifo_out_endofpacket;                     // SD_avalon_sdcard_slave_agent_rsp_fifo:out_endofpacket -> SD_avalon_sdcard_slave_agent:rf_sink_endofpacket
	wire          cmd_mux_001_src_valid;                                                     // cmd_mux_001:src_valid -> SD_avalon_sdcard_slave_agent:cp_valid
	wire  [106:0] cmd_mux_001_src_data;                                                      // cmd_mux_001:src_data -> SD_avalon_sdcard_slave_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                     // SD_avalon_sdcard_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [8:0] cmd_mux_001_src_channel;                                                   // cmd_mux_001:src_channel -> SD_avalon_sdcard_slave_agent:cp_channel
	wire          cmd_mux_001_src_startofpacket;                                             // cmd_mux_001:src_startofpacket -> SD_avalon_sdcard_slave_agent:cp_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                               // cmd_mux_001:src_endofpacket -> SD_avalon_sdcard_slave_agent:cp_endofpacket
	...
	wire          cmd_mux_002_src_valid;                                                     // cmd_mux_002:src_valid -> usb_avalon_usb_slave_agent:cp_valid
	wire  [106:0] cmd_mux_002_src_data;                                                      // cmd_mux_002:src_data -> usb_avalon_usb_slave_agent:cp_data
	wire          cmd_mux_002_src_ready;                                                     // usb_avalon_usb_slave_agent:cp_ready -> cmd_mux_002:src_ready
	wire    [8:0] cmd_mux_002_src_channel;                                                   // cmd_mux_002:src_channel -> usb_avalon_usb_slave_agent:cp_channel
	wire          cmd_mux_002_src_startofpacket;                                             // cmd_mux_002:src_startofpacket -> usb_avalon_usb_slave_agent:cp_startofpacket
	wire          cmd_mux_002_src_endofpacket;                                               // cmd_mux_002:src_endofpacket -> usb_avalon_usb_slave_agent:cp_endofpacket
	...
	wire  [106:0] cmd_mux_003_src_data;                                                      // cmd_mux_003:src_data -> sysid_control_slave_agent:cp_data
	...
	wire   [28:0] performance_counter_control_slave_agent_m0_address;                        // performance_counter_control_slave_agent:m0_address -> performance_counter_control_slave_translator:uav_address
	...
	wire          cmd_mux_004_src_valid;                                                     // cmd_mux_004:src_valid -> performance_counter_control_slave_agent:cp_valid
	wire  [106:0] cmd_mux_004_src_data;                                                      // cmd_mux_004:src_data -> performance_counter_control_slave_agent:cp_data
	wire          cmd_mux_004_src_ready;                                                     // performance_counter_control_slave_agent:cp_ready -> cmd_mux_004:src_ready
	wire    [8:0] cmd_mux_004_src_channel;                                                   // cmd_mux_004:src_channel -> performance_counter_control_slave_agent:cp_channel
	wire          cmd_mux_004_src_startofpacket;                                             // cmd_mux_004:src_startofpacket -> performance_counter_control_slave_agent:cp_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                               // cmd_mux_004:src_endofpacket -> performance_counter_control_slave_agent:cp_endofpacket
	...
	wire  [106:0] cmd_mux_007_src_data;                                                      // cmd_mux_007:src_data -> onchip_memory_s1_agent:cp_data
	...
	wire          sd_avalon_sdcard_slave_agent_rp_valid;                                     // SD_avalon_sdcard_slave_agent:rp_valid -> router_003:sink_valid
	wire  [106:0] sd_avalon_sdcard_slave_agent_rp_data;                                      // SD_avalon_sdcard_slave_agent:rp_data -> router_003:sink_data
	wire          sd_avalon_sdcard_slave_agent_rp_ready;                                     // router_003:sink_ready -> SD_avalon_sdcard_slave_agent:rp_ready
	wire          sd_avalon_sdcard_slave_agent_rp_startofpacket;                             // SD_avalon_sdcard_slave_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          sd_avalon_sdcard_slave_agent_rp_endofpacket;                               // SD_avalon_sdcard_slave_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire          usb_avalon_usb_slave_agent_rp_valid;                                       // usb_avalon_usb_slave_agent:rp_valid -> router_004:sink_valid
	wire  [106:0] usb_avalon_usb_slave_agent_rp_data;                                        // usb_avalon_usb_slave_agent:rp_data -> router_004:sink_data
	wire          usb_avalon_usb_slave_agent_rp_ready;                                       // router_004:sink_ready -> usb_avalon_usb_slave_agent:rp_ready
	wire          usb_avalon_usb_slave_agent_rp_startofpacket;                               // usb_avalon_usb_slave_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire          usb_avalon_usb_slave_agent_rp_endofpacket;                                 // usb_avalon_usb_slave_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire  [106:0] sysid_control_slave_agent_rp_data;                                         // sysid_control_slave_agent:rp_data -> router_005:sink_data
	...
	wire          performance_counter_control_slave_agent_rp_valid;                          // performance_counter_control_slave_agent:rp_valid -> router_006:sink_valid
	wire  [106:0] performance_counter_control_slave_agent_rp_data;                           // performance_counter_control_slave_agent:rp_data -> router_006:sink_data
	wire          performance_counter_control_slave_agent_rp_ready;                          // router_006:sink_ready -> performance_counter_control_slave_agent:rp_ready
	wire          performance_counter_control_slave_agent_rp_startofpacket;                  // performance_counter_control_slave_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire          performance_counter_control_slave_agent_rp_endofpacket;                    // performance_counter_control_slave_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire  [106:0] onchip_memory_s1_agent_rp_data;                                            // onchip_memory_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [106:0] cmd_demux_001_src2_data;                                                   // cmd_demux_001:src2_data -> cmd_mux_007:sink1_data
	...
	wire  [106:0] rsp_demux_007_src1_data;                                                   // rsp_demux_007:src1_data -> rsp_mux_001:sink2_data
	...
	wire          sd_avalon_sdcard_slave_agent_rdata_fifo_src_valid;                         // SD_avalon_sdcard_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] sd_avalon_sdcard_slave_agent_rdata_fifo_src_data;                          // SD_avalon_sdcard_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_001:in_0_data
	wire          sd_avalon_sdcard_slave_agent_rdata_fifo_src_ready;                         // avalon_st_adapter_001:in_0_ready -> SD_avalon_sdcard_slave_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_001_out_0_valid;                                         // avalon_st_adapter_001:out_0_valid -> SD_avalon_sdcard_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                                          // avalon_st_adapter_001:out_0_data -> SD_avalon_sdcard_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                                         // SD_avalon_sdcard_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                                         // avalon_st_adapter_001:out_0_error -> SD_avalon_sdcard_slave_agent:rdata_fifo_sink_error
	wire          usb_avalon_usb_slave_agent_rdata_fifo_src_valid;                           // usb_avalon_usb_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire   [33:0] usb_avalon_usb_slave_agent_rdata_fifo_src_data;                            // usb_avalon_usb_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire          usb_avalon_usb_slave_agent_rdata_fifo_src_ready;                           // avalon_st_adapter_002:in_0_ready -> usb_avalon_usb_slave_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_002_out_0_valid;                                         // avalon_st_adapter_002:out_0_valid -> usb_avalon_usb_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_002_out_0_data;                                          // avalon_st_adapter_002:out_0_data -> usb_avalon_usb_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_002_out_0_ready;                                         // usb_avalon_usb_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire    [0:0] avalon_st_adapter_002_out_0_error;                                         // avalon_st_adapter_002:out_0_error -> usb_avalon_usb_slave_agent:rdata_fifo_sink_error
	...
	wire          performance_counter_control_slave_agent_rdata_fifo_src_valid;              // performance_counter_control_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire   [33:0] performance_counter_control_slave_agent_rdata_fifo_src_data;               // performance_counter_control_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire          performance_counter_control_slave_agent_rdata_fifo_src_ready;              // avalon_st_adapter_004:in_0_ready -> performance_counter_control_slave_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_004_out_0_valid;                                         // avalon_st_adapter_004:out_0_valid -> performance_counter_control_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_004_out_0_data;                                          // avalon_st_adapter_004:out_0_data -> performance_counter_control_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_004_out_0_ready;                                         // performance_counter_control_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire    [0:0] avalon_st_adapter_004_out_0_error;                                         // avalon_st_adapter_004:out_0_error -> performance_counter_control_slave_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) sd_avalon_sdcard_slave_translator (
		.clk                    (sys_sdram_pll_sys_clk_clk),                     //                      clk.clk
		.reset                  (cpu_reset_reset_bridge_in_reset_reset),         //                    reset.reset
		.uav_address            (sd_avalon_sdcard_slave_agent_m0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (sd_avalon_sdcard_slave_agent_m0_burstcount),    //                         .burstcount
		.uav_read               (sd_avalon_sdcard_slave_agent_m0_read),          //                         .read
		.uav_write              (sd_avalon_sdcard_slave_agent_m0_write),         //                         .write
		.uav_waitrequest        (sd_avalon_sdcard_slave_agent_m0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (sd_avalon_sdcard_slave_agent_m0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (sd_avalon_sdcard_slave_agent_m0_byteenable),    //                         .byteenable
		.uav_readdata           (sd_avalon_sdcard_slave_agent_m0_readdata),      //                         .readdata
		.uav_writedata          (sd_avalon_sdcard_slave_agent_m0_writedata),     //                         .writedata
		.uav_lock               (sd_avalon_sdcard_slave_agent_m0_lock),          //                         .lock
		.uav_debugaccess        (sd_avalon_sdcard_slave_agent_m0_debugaccess),   //                         .debugaccess
		.av_address             (SD_avalon_sdcard_slave_address),                //      avalon_anti_slave_0.address
		.av_write               (SD_avalon_sdcard_slave_write),                  //                         .write
		.av_read                (SD_avalon_sdcard_slave_read),                   //                         .read
		.av_readdata            (SD_avalon_sdcard_slave_readdata),               //                         .readdata
		.av_writedata           (SD_avalon_sdcard_slave_writedata),              //                         .writedata
		.av_byteenable          (SD_avalon_sdcard_slave_byteenable),             //                         .byteenable
		.av_waitrequest         (SD_avalon_sdcard_slave_waitrequest),            //                         .waitrequest
		.av_chipselect          (SD_avalon_sdcard_slave_chipselect),             //                         .chipselect
		.av_begintransfer       (),                                              //              (terminated)
		.av_beginbursttransfer  (),                                              //              (terminated)
		.av_burstcount          (),                                              //              (terminated)
		.av_readdatavalid       (1'b0),                                          //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) sd_avalon_sdcard_slave_agent (
		.clk                     (sys_sdram_pll_sys_clk_clk),                               //             clk.clk
		.reset                   (cpu_reset_reset_bridge_in_reset_reset),                   //       clk_reset.reset
		.m0_address              (sd_avalon_sdcard_slave_agent_m0_address),                 //              m0.address
		.m0_burstcount           (sd_avalon_sdcard_slave_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (sd_avalon_sdcard_slave_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (sd_avalon_sdcard_slave_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (sd_avalon_sdcard_slave_agent_m0_lock),                    //                .lock
		.m0_readdata             (sd_avalon_sdcard_slave_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (sd_avalon_sdcard_slave_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (sd_avalon_sdcard_slave_agent_m0_read),                    //                .read
		.m0_waitrequest          (sd_avalon_sdcard_slave_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (sd_avalon_sdcard_slave_agent_m0_writedata),               //                .writedata
		.m0_write                (sd_avalon_sdcard_slave_agent_m0_write),                   //                .write
		.rp_endofpacket          (sd_avalon_sdcard_slave_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (sd_avalon_sdcard_slave_agent_rp_ready),                   //                .ready
		.rp_valid                (sd_avalon_sdcard_slave_agent_rp_valid),                   //                .valid
		.rp_data                 (sd_avalon_sdcard_slave_agent_rp_data),                    //                .data
		.rp_startofpacket        (sd_avalon_sdcard_slave_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (sd_avalon_sdcard_slave_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (sd_avalon_sdcard_slave_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (sd_avalon_sdcard_slave_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (sd_avalon_sdcard_slave_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (sd_avalon_sdcard_slave_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (sd_avalon_sdcard_slave_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (sd_avalon_sdcard_slave_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (sd_avalon_sdcard_slave_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (sd_avalon_sdcard_slave_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (sd_avalon_sdcard_slave_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_001_out_0_ready),                       // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_001_out_0_valid),                       //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_001_out_0_data),                        //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_001_out_0_error),                       //                .error
		.rdata_fifo_src_ready    (sd_avalon_sdcard_slave_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (sd_avalon_sdcard_slave_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (sd_avalon_sdcard_slave_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                                   //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                     //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) sd_avalon_sdcard_slave_agent_rsp_fifo (
		.clk               (sys_sdram_pll_sys_clk_clk),                               //       clk.clk
		.reset             (cpu_reset_reset_bridge_in_reset_reset),                   // clk_reset.reset
		.in_data           (sd_avalon_sdcard_slave_agent_rf_source_data),             //        in.data
		.in_valid          (sd_avalon_sdcard_slave_agent_rf_source_valid),            //          .valid
		.in_ready          (sd_avalon_sdcard_slave_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (sd_avalon_sdcard_slave_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (sd_avalon_sdcard_slave_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (sd_avalon_sdcard_slave_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (sd_avalon_sdcard_slave_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (sd_avalon_sdcard_slave_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (sd_avalon_sdcard_slave_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (sd_avalon_sdcard_slave_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                                   // (terminated)
		.csr_read          (1'b0),                                                    // (terminated)
		.csr_write         (1'b0),                                                    // (terminated)
		.csr_readdata      (),                                                        // (terminated)
	...
	niosii_USB_mm_interconnect_0_router router (
	...
	niosii_USB_mm_interconnect_0_router_001 router_001 (
	...
	niosii_USB_mm_interconnect_0_router_002 router_002 (
	...
	niosii_USB_mm_interconnect_0_router_002 router_003 (
		.sink_ready         (sd_avalon_sdcard_slave_agent_rp_ready),         //      sink.ready
		.sink_valid         (sd_avalon_sdcard_slave_agent_rp_valid),         //          .valid
		.sink_data          (sd_avalon_sdcard_slave_agent_rp_data),          //          .data
		.sink_startofpacket (sd_avalon_sdcard_slave_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (sd_avalon_sdcard_slave_agent_rp_endofpacket),   //          .endofpacket
		.clk                (sys_sdram_pll_sys_clk_clk),                     //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset),         // clk_reset.reset
	...
	niosii_USB_mm_interconnect_0_router_002 router_004 (
	...
	niosii_USB_mm_interconnect_0_router_002 router_005 (
	...
	niosii_USB_mm_interconnect_0_router_002 router_006 (
	...
	niosii_USB_mm_interconnect_0_router_007 router_007 (
	...
	niosii_USB_mm_interconnect_0_router_007 router_008 (
	...
	niosii_USB_mm_interconnect_0_router_007 router_009 (
	...
	niosii_USB_mm_interconnect_0_router_002 router_010 (
	...
	niosii_USB_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (sys_sdram_pll_sys_clk_clk),                     //        clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset),         //  clk_reset.reset
	...
	niosii_USB_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (sys_sdram_pll_sys_clk_clk),                            //        clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset),                //  clk_reset.reset
	...
	niosii_USB_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (sys_sdram_pll_sys_clk_clk),             //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosii_USB_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (sys_sdram_pll_sys_clk_clk),             //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosii_USB_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (sys_sdram_pll_sys_clk_clk),             //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosii_USB_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (sys_sdram_pll_sys_clk_clk),             //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosii_USB_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (sys_sdram_pll_sys_clk_clk),             //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosii_USB_mm_interconnect_0_cmd_mux_005 cmd_mux_005 (
		.clk                 (sys_sdram_pll_sys_clk_clk),             //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosii_USB_mm_interconnect_0_cmd_mux_005 cmd_mux_006 (
		.clk                 (sys_sdram_pll_sys_clk_clk),             //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosii_USB_mm_interconnect_0_cmd_mux_005 cmd_mux_007 (
		.clk                 (sys_sdram_pll_sys_clk_clk),             //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosii_USB_mm_interconnect_0_cmd_mux cmd_mux_008 (
		.clk                 (sys_sdram_pll_sys_clk_clk),             //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosii_USB_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (sys_sdram_pll_sys_clk_clk),             //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosii_USB_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (sys_sdram_pll_sys_clk_clk),             //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosii_USB_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (sys_sdram_pll_sys_clk_clk),             //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosii_USB_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (sys_sdram_pll_sys_clk_clk),             //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosii_USB_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (sys_sdram_pll_sys_clk_clk),             //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosii_USB_mm_interconnect_0_rsp_demux_005 rsp_demux_005 (
		.clk                (sys_sdram_pll_sys_clk_clk),             //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosii_USB_mm_interconnect_0_rsp_demux_005 rsp_demux_006 (
		.clk                (sys_sdram_pll_sys_clk_clk),             //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosii_USB_mm_interconnect_0_rsp_demux_005 rsp_demux_007 (
		.clk                (sys_sdram_pll_sys_clk_clk),             //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosii_USB_mm_interconnect_0_rsp_demux rsp_demux_008 (
		.clk                (sys_sdram_pll_sys_clk_clk),             //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosii_USB_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (sys_sdram_pll_sys_clk_clk),             //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosii_USB_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (sys_sdram_pll_sys_clk_clk),             //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosii_USB_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	niosii_USB_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (sys_sdram_pll_sys_clk_clk),                         // in_clk_0.clk
		.in_rst_0_reset (cpu_reset_reset_bridge_in_reset_reset),             // in_rst_0.reset
		.in_0_data      (sd_avalon_sdcard_slave_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (sd_avalon_sdcard_slave_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (sd_avalon_sdcard_slave_agent_rdata_fifo_src_ready), //         .ready
