...
module niosii_USB_mm_interconnect_0 (
	...
	wire  [106:0] cmd_mux_003_src_data;                                                      // cmd_mux_003:src_data -> performance_counter_control_slave_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                     // performance_counter_control_slave_agent:cp_ready -> cmd_mux_003:src_ready
	wire    [8:0] cmd_mux_003_src_channel;                                                   // cmd_mux_003:src_channel -> performance_counter_control_slave_agent:cp_channel
	...
	wire          cmd_mux_005_src_valid;                                                     // cmd_mux_005:src_valid -> CY7C67200_IF_0_hpi_agent:cp_valid
	wire  [106:0] cmd_mux_005_src_data;                                                      // cmd_mux_005:src_data -> CY7C67200_IF_0_hpi_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                     // CY7C67200_IF_0_hpi_agent:cp_ready -> cmd_mux_005:src_ready
	wire    [8:0] cmd_mux_005_src_channel;                                                   // cmd_mux_005:src_channel -> CY7C67200_IF_0_hpi_agent:cp_channel
	wire          cmd_mux_005_src_startofpacket;                                             // cmd_mux_005:src_startofpacket -> CY7C67200_IF_0_hpi_agent:cp_startofpacket
	wire          cmd_mux_005_src_endofpacket;                                               // cmd_mux_005:src_endofpacket -> CY7C67200_IF_0_hpi_agent:cp_endofpacket
	...
	wire  [106:0] performance_counter_control_slave_agent_rp_data;                           // performance_counter_control_slave_agent:rp_data -> router_005:sink_data
	...
	wire          cy7c67200_if_0_hpi_agent_rp_valid;                                         // CY7C67200_IF_0_hpi_agent:rp_valid -> router_007:sink_valid
	wire  [106:0] cy7c67200_if_0_hpi_agent_rp_data;                                          // CY7C67200_IF_0_hpi_agent:rp_data -> router_007:sink_data
	wire          cy7c67200_if_0_hpi_agent_rp_ready;                                         // router_007:sink_ready -> CY7C67200_IF_0_hpi_agent:rp_ready
	wire          cy7c67200_if_0_hpi_agent_rp_startofpacket;                                 // CY7C67200_IF_0_hpi_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire          cy7c67200_if_0_hpi_agent_rp_endofpacket;                                   // CY7C67200_IF_0_hpi_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire          cy7c67200_if_0_hpi_agent_rdata_fifo_src_valid;                             // CY7C67200_IF_0_hpi_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire   [33:0] cy7c67200_if_0_hpi_agent_rdata_fifo_src_data;                              // CY7C67200_IF_0_hpi_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire          cy7c67200_if_0_hpi_agent_rdata_fifo_src_ready;                             // avalon_st_adapter_005:in_0_ready -> CY7C67200_IF_0_hpi_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_005_out_0_valid;                                         // avalon_st_adapter_005:out_0_valid -> CY7C67200_IF_0_hpi_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_005_out_0_data;                                          // avalon_st_adapter_005:out_0_data -> CY7C67200_IF_0_hpi_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_005_out_0_ready;                                         // CY7C67200_IF_0_hpi_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire    [0:0] avalon_st_adapter_005_out_0_error;                                         // avalon_st_adapter_005:out_0_error -> CY7C67200_IF_0_hpi_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_WRITE_WAIT_CYCLES           (9),
		.AV_SETUP_WAIT_CYCLES           (9),
		.AV_DATA_HOLD_CYCLES            (9)
	...
	niosii_USB_mm_interconnect_0_router_006 router_006 (
	...
	niosii_USB_mm_interconnect_0_router_002 router_007 (
	...
	niosii_USB_mm_interconnect_0_router_006 router_008 (
	...
	niosii_USB_mm_interconnect_0_router_006 router_009 (
	...
	niosii_USB_mm_interconnect_0_cmd_mux_004 cmd_mux_004 (
		.clk                 (sys_sdram_pll_sys_clk_clk),             //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosii_USB_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (sys_sdram_pll_sys_clk_clk),             //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosii_USB_mm_interconnect_0_cmd_mux_004 cmd_mux_006 (
		.clk                 (sys_sdram_pll_sys_clk_clk),             //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosii_USB_mm_interconnect_0_cmd_mux_004 cmd_mux_007 (
		.clk                 (sys_sdram_pll_sys_clk_clk),             //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosii_USB_mm_interconnect_0_rsp_demux_004 rsp_demux_004 (
		.clk                (sys_sdram_pll_sys_clk_clk),             //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosii_USB_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (sys_sdram_pll_sys_clk_clk),             //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosii_USB_mm_interconnect_0_rsp_demux_004 rsp_demux_006 (
		.clk                (sys_sdram_pll_sys_clk_clk),             //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosii_USB_mm_interconnect_0_rsp_demux_004 rsp_demux_007 (
		.clk                (sys_sdram_pll_sys_clk_clk),             //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
