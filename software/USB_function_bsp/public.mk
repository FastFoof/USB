...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../niosii_USB.sopcinfo
...
# Design Name 
# setting SOPC_NAME is niosii_USB
SOPC_NAME := niosii_USB
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x100114b0
SOPC_SYSID_FLAG += --sidp=0x100114b0
ELF_PATCH_FLAG  += --sidp 0x100114b0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1640965422
SOPC_SYSID_FLAG += --timestamp=1640965422
ELF_PATCH_FLAG  += --timestamp 1640965422
