	nios_system u0 (
		.alpha_blending_avalon_background_sink_data          (<connected-to-alpha_blending_avalon_background_sink_data>),          // alpha_blending_avalon_background_sink.data
		.alpha_blending_avalon_background_sink_startofpacket (<connected-to-alpha_blending_avalon_background_sink_startofpacket>), //                                      .startofpacket
		.alpha_blending_avalon_background_sink_endofpacket   (<connected-to-alpha_blending_avalon_background_sink_endofpacket>),   //                                      .endofpacket
		.alpha_blending_avalon_background_sink_valid         (<connected-to-alpha_blending_avalon_background_sink_valid>),         //                                      .valid
		.alpha_blending_avalon_background_sink_ready         (<connected-to-alpha_blending_avalon_background_sink_ready>),         //                                      .ready
